DROP FUNCTION IF EXISTS hmlg.f_v_vzs_vzdo_d(character varying) CASCADE;
CREATE OR REPLACE
FUNCTION hmlg.f_v_vzs_vzdo_d(
...
$$
  LANGUAGE 'plpgsql';
ALTER FUNCTION hmlg.f_v_vzs_vzdo_d(character varying) OWNER TO postgres;
