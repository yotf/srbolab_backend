DROP FUNCTION IF EXISTS hmlg.f_v_vz_vzk_d(character varying) CASCADE;
CREATE OR REPLACE
FUNCTION hmlg.f_v_vz_vzk_d(
...
$$
  LANGUAGE 'plpgsql';
ALTER FUNCTION hmlg.f_v_vz_vzk_d(character varying) OWNER TO postgres;
