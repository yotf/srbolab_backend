DROP FUNCTION IF EXISTS sif.f_v_vzkl_vzpv_iu(character varying) CASCADE;
CREATE OR REPLACE
FUNCTION sif.f_v_vzkl_vzpv_iu(
...
DECLARE
  ...
  r_new sif.v_vzkl_vzpv;
  r_old sif.v_vzkl_vzpv;
...
BEGIN
  ...
  SELECT j.*
    INTO r_new
    FROM json_populate_record(null::sif.v_vzkl_vzpv, j_rec) j;
...
$$
  LANGUAGE 'plpgsql';
ALTER FUNCTION sif.f_v_vzkl_vzpv_iu(character varying) OWNER TO postgres;
