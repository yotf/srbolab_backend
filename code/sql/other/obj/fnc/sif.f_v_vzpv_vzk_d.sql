DROP FUNCTION IF EXISTS sif.f_v_vzpv_vzk_d(character varying) CASCADE;
CREATE OR REPLACE
FUNCTION sif.f_v_vzpv_vzk_d(
...
$$
  LANGUAGE 'plpgsql';
ALTER FUNCTION sif.f_v_vzpv_vzk_d(character varying) OWNER TO postgres;
