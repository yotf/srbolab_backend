...
CREATE TABLE sys.lokacija(
 ...
 lk_aktivna Character(1) DEFAULT 'D' NOT NULL
        CHECK (lk_aktivna IN ('D', 'N'))
)
WITH (
 autovacuum_enabled=true)
;
...
CREATE TABLE hmlg.klijent(
 ...
 kl_firma Character(1) DEFAULT 'N'
        CHECK (kl_firma IN ('D', 'N'))
)
WITH (
 autovacuum_enabled=true)
;
...
CREATE TABLE sys.korisnik(
 ...
 kr_aktivan Character(1) DEFAULT 'D' NOT NULL
        CHECK (kr_aktivan IN ('D', 'N')),
 arl_id Integer NOT NULL
)
WITH (
 autovacuum_enabled=true)
...
CREATE TABLE hmlg.vozilo(
 ...
 vz_godina Integer DEFAULT 0
        CHECK (vz_godina>=0),
 vz_reg Character varying(10),
 vz_mesta_sedenje Integer DEFAULT 0
        CHECK (vz_mesta_sedenje>=0),
 vz_mesta_stajanje Integer DEFAULT 0
        CHECK (vz_mesta_stajanje>=0),
 vz_masa Integer DEFAULT 0
        CHECK (vz_masa>=0),
 vz_nosivost Integer DEFAULT 0
        CHECK (vz_nosivost>=0),
 vz_masa_max Integer DEFAULT 0
        CHECK (vz_masa_max>=0),
 vz_duzina Integer DEFAULT 0
        CHECK (vz_duzina>=0),
 vz_sirina Integer DEFAULT 0
        CHECK (vz_sirina>=0),
 vz_visina Integer DEFAULT 0
        CHECK (vz_visina>=0),
 vz_kuka Character(1) DEFAULT 'N'
        CHECK (vz_kuka IN ('D', 'N')),
 vz_kuka_sert Character varying(50),
 vz_km Integer DEFAULT 0
        CHECK (vz_km>=0),
 vz_max_brzina Integer DEFAULT 0
        CHECK (vz_max_brzina>=0),
 vz_kw_kg Numeric(20,2),
 vz_motor Character varying(30),
 vz_co2 Numeric(10,3),
 vz_elektro Character(1) DEFAULT 'N'
        CHECK (vz_elektro IN ('D', 'N')),
...
CREATE TABLE hmlg.vozilo_sert(
 ...
 vzs_godina Integer DEFAULT 0
        CHECK (vzs_godina>=0),
 vzs_mesta_sedenje Integer DEFAULT 0
        CHECK (vzs_mesta_sedenje>=0),
 vzs_mesta_stajanje Integer DEFAULT 0
        CHECK (vzs_mesta_stajanje>=0),
 vzs_masa Integer DEFAULT 0
        CHECK (vzs_masa>=0),
 vzs_nosivost Integer DEFAULT 0
        CHECK (vzs_nosivost>=0),
 vzs_masa_max Integer DEFAULT 0
        CHECK (vzs_masa_max>=0),
 vzs_duzina Integer DEFAULT 0
        CHECK (vzs_duzina>=0),
 vzs_sirina Integer DEFAULT 0
        CHECK (vzs_sirina>=0),
 vzs_visina Integer DEFAULT 0
        CHECK (vzs_visina>=0),
 vzs_kuka_sert Character varying(50),
 vzs_max_brzina Integer DEFAULT 0
        CHECK (vzs_max_brzina>=0),
...
CREATE TABLE hmlg.vozilo_osovina(
 ...
 vzo_nosivost Integer DEFAULT 0 NOT NULL
        CHECK (vzo_nosivost>=0),
 vzo_tockova Integer DEFAULT 0 NOT NULL
        CHECK (vzo_tockova>=0),
...
CREATE TABLE hmlg.vozilo_s_osovina(
 ...
 vzos_nosivost Integer DEFAULT 0 NOT NULL
        CHECK (vzos_nosivost>=0),
 vzos_tockova Integer DEFAULT 0 NOT NULL
        CHECK (vzos_tockova>=0),
...
CREATE TABLE hmlg.vozilo_gas(
 ...
 vzg_tip Character varying(10) DEFAULT 'TNG'
        CHECK (vzg_tip IN ('TNG', 'KPG')),
 vzg_aktivan Character(1) DEFAULT 'D'
        CHECK (vzg_aktivan IN ('D', 'N'))
)
WITH (
 autovacuum_enabled=true)
;
...
CREATE TABLE sif.ag_uredjaj(
 agu_id Integer NOT NULL,
 agu_oznaka Character(2) DEFAULT 'RZ' NOT NULL
        CHECK (agu_oznaka IN ('MV', 'RD', 'RZ')),
...
CREATE TABLE sif.motor_tip(
 ...
 mtt_oznaka Character(1) DEFAULT 'B' NOT NULL
        CHECK (mtt_oznaka IN ('B', 'D', 'E')),
...
CREATE TABLE hmlg.predmet_status(
 ...
 prs_priprema Character(1) DEFAULT 'D'
        CHECK (prs_priprema IN ('D', 'N')),
 prs_cekanje Character(1) DEFAULT 'N'
        CHECK (prs_cekanje IN ('D', 'N')),
 prs_zakljucen Character(1) DEFAULT 'N'
        CHECK (prs_zakljucen IN ('D', 'N')),
 prs_neusag Character(1) DEFAULT 'N'
        CHECK (prs_neusag IN ('D', 'N'))
)
WITH (
 autovacuum_enabled=true)
;
