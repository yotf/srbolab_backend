DROP FUNCTION IF EXISTS public.f_lat2cir_rn(text, integer) CASCADE;
CREATE OR REPLACE
FUNCTION public.f_lat2cir_rn(
                             pc_text text,
...
ALTER FUNCTION public.f_lat2cir_rn(text, integer) OWNER TO postgres;
